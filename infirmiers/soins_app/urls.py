...
from .views.soin_list import SoinListView
...
urlpatterns = [
    ...
    url('^soins$', SoinListView.as_view(), name='soin_list'),
    url('^soins/(?P<soin_id>\d+)', SoinListView.as_view(), name='soin_list'),
    url('^patients$', PatientListView.as_view(), name='patient_list'),
    url('^patients/(?P<patient_id>\d+)', PatientListView.as_view(), name='patient_list'),
